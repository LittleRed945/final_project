...
//    }
    ...
    func player_is_front()->Bool{
        ...
        if self.characters[self.now_index].action%4==0,now_player_board_pos+16<16*16,self.object_board[now_player_board_pos+16].object == .player{
            ...
            return true
        }else if self.characters[self.now_index].action%4==2,now_player_board_pos%16+1<16,self.object_board[now_player_board_pos%16+1].object == .player{
            return true
        }else if self.characters[self.now_index].action%4==2,now_player_board_pos%16-1>=0,self.object_board[now_player_board_pos%16-1].object == .player{
            return true
        }
